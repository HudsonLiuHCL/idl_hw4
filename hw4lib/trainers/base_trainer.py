...
class BaseTrainer(ABC):
    ...
    def _init_experiment(self, run_name: str, config_file: str):
        """Initialize experiment directories, save config, and write model summary (UTF-8 safe)."""
        ...
        # -----------------------------
        # Save model architecture summary (UTF-8 encoding)
        # -----------------------------
        model_arch_path = expt_root / "model_arch.txt"

        # Prepare model summary input
        ...
        # Safely write summary with UTF-8
